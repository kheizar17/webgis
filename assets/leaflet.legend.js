(function (factory, window) {
    ...
    /**
     * åœ†å¿ƒåæ ‡ï¼š(x0,y0) åŠå¾„ï¼šr è§’åº¦(Xè½´é¡ºæ—¶é’ˆæ—‹è½¬)ï¼ša
     * å¼§åº¦ = è§’åº¦ * Math.PI / 180
     * åˆ™åœ†ä¸Šä»»ä¸€ç‚¹ä¸ºï¼šï¼ˆx1,y1ï¼‰
     * x1 Â  = Â  x0 Â  + Â  r Â  * Â  Math.cos( a  * Math.PI / 180)
     * y1 Â  = Â  y0 Â  + Â  r Â  * Â  Math.sin( a  * Math.PI / 180)
     */
